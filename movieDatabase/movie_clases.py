...
class Pelicula:
    ...
    def __str__(self):
        '''Metodo para imprimir el objeto Película'''
        return f'{self.titulo_pelicula} ({self.fecha_lanzamiento.year})'
    
class Relacion:
    '''Clase Relación: Relacion entre actores y peliculas'''
...
class SistemaCine:
    '''Clase SistemaCine: Sistema de información de películas'''
    def __init__(self):
    ...
    def obtener_peliculas_por_actor(self, id_estrella):
        '''Método para obtener las pellículas de un actor'''
