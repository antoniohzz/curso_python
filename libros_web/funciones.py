'''Archivo con las funciones necesarias de la Aplicacion Liberos Web'''
import csv

def lee_archivo_csv(archivo:str)->list:
    '''Lee un archivo CSV y lo comvierte en una lista de diccionarios'''
    with open(archivo, "r", encoding='utf8') as f:
        return [x for x in csv.DictReader(f)]
    
def crea_diccionario(lista:list, llave:str)->dict:
    '''Çrea un diccionario con los titulos como clave y el resto de los datos como valores'''
